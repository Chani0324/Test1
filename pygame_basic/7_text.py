...
# 적
enemy = pygame.image.load("C:/Users/YSJ/Desktop/PythonWorkspace/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size  # 이미지의 크기 설정
enemy_width = enemy_size[0]     # 캐릭터 가로 크기
enemy_height = enemy_size[1]    # 캐릭터 세로 크기
enemy_x_pos = (screen_width - enemy_size[0]) / 2  # 화면 중앙에 캐릭터가 위치하도록
enemy_y_pos = (screen_height - enemy_height) / 2   # 화면 가장 아래 부분에 캐릭터가 위치하도록
